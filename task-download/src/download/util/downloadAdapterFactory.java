...
public class downloadAdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected static downloadPackage modelPackage;
   ...
   * @generated
   */
  public downloadAdapterFactory()
  {
    if (modelPackage == null)
    {
      modelPackage = downloadPackage.eINSTANCE;
    }
  }
   ...
   * @generated
   */
  protected downloadSwitch<Adapter> modelSwitch = new downloadSwitch<Adapter>()
  {
    @Override
    public Adapter casedownloadTask(downloadTask object)
    {
      return createdownloadTaskAdapter();
    }
  ...
  /**
   * Creates a new adapter for an object of class '{@link download.downloadTask <em>Task</em>}'.
   * <!-- begin-user-doc -->
